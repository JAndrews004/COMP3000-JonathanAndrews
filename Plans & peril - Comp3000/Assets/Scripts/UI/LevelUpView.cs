...
public class LevelUpView : MonoBehaviour
{
    ...
    public void Bind(LevelUpViewModel viewModel)
    {
        vm = viewModel;
        ...
        DamageStat.text = $"{vm.character.CurrentAttack} -> <color=#00FF00>{vm.character.CurrentAttack + 1 + vm.DamangeIncrease}</color>";
        DefenseStat.text = $"{vm.character.CurrentDefense} -> <color=#00FF00>{vm.character.CurrentDefense + 1 + vm.DefenseIncrease}</color>";
        IntelligenceStat.text = $"{vm.character.CurrentIntelligence} -> <color=#00FF00>{vm.character.CurrentIntelligence + 1 + vm.IntelligenceIncrease}</color>";
        MagicDefenseStat.text = $"{vm.character.CurrentMagicDefense} -> <color=#00FF00>{vm.character.CurrentMagicDefense + 1 + vm.MagicDefenseIncrease}</color>";
        LuckStat.text = $"{vm.character.CurrentLuck} -> <color=#00FF00>{vm.character.CurrentLuck + 1 + vm.LuckIncrease}</color>";
        HpStat.text = $"{vm.character.CurrentMaxHealth/10} -> <color=#00FF00>{vm.character.CurrentMaxHealth/10 + 1 + vm.HpIncrease}</color>";
